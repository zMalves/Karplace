<?php
    ...
    class Vehicle {
         ...
         */
        public function getAvailableTransmissions(): array {
            return [
                'manual' => 'Manual',
         ...
         */
        public function createBrand($name, $logo = null): int|false {
         ...
         */
        public function createModel($brand_id, $name): int|false {
